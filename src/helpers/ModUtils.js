...
const logModeration = async (issuer, target, reason, type, data = {}) => {
  ...
  switch (type.toUpperCase()) {
    case "PURGE":
      ...
      fields.push({ name: "Purge Type", value: data.purgeType, inline: true }, { name: "Messages", value: data.deletedCount.toString(), inline: true }, { name: "Channel", value: `#${data.channel.name} [${data.channel.id}]`, inline: false });
      break;
